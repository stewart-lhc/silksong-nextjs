        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold fantasy-text mb-4 text-foreground">
              Silksong Announcements
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Complete history of Hollow Knight: Silksong announcements from Team Cherry, 
              major reveals, and official development updates since 2017
            </p>
          </div>
        </div>
      </div>
            ...
            <Card className="card-enhanced max-w-2xl mx-auto">
              <CardContent className="pt-6">
                <p className="text-muted-foreground text-sm leading-relaxed">
                  This announcement history is maintained with official Team Cherry sources and major gaming announcements. 
